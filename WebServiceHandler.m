...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    //###################################################################
    if ((self.requestType == eLogin) ||(self.requestType == eSignUp) || (self.requestType == eUploadImage) || (self.requestType == eFblogin) || (self.requestType == eResetpwd))
	{
	...
	if ([resArr count] == 0)
    {
        ...
        NSDictionary *loc = nil; // [[NSDictionary alloc]init];
