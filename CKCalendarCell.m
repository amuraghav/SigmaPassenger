...
- (id)init
{
    ...
    if (self) {
        ...
        //  Normal Cell Colors
        _normalBackgroundColor = [UIColor whiteColor]; //kCalendarColorLightGray;
        _selectedBackgroundColor = BUTTON_VIEW_Color;//kCalendarColorBlue;
        _inactiveSelectedBackgroundColor = kCalendarColorDarkGray;

        //  Today Cell Colors
        _todayBackgroundColor = [UIColor lightGrayColor];//kCalendarColorBluishGray;
        _todaySelectedBackgroundColor = BUTTON_VIEW_Color;//kCalendaryellow;
...
{    
   ...
   // [self showBorder]; //change by 3Embed
}
