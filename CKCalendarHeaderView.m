...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_monthTitle setBackgroundColor:NavBarTint_Color];
        [_monthTitle setTextAlignment:NSTextAlignmentCenter];
        [_monthTitle setFont:[UIFont fontWithName:Trebuchet_MS size:20]];
...
- (UILabel *)_columnLabelWithTitle:(NSString *)title
{
    ...
    //[l setTextColor:kCalendarColorHeaderWeekdayTitle]; //change 3Embed
    [l setTextColor:[UIColor colorWithRed:0.041 green:0.089 blue:0.185 alpha:1.000]];
    //[l setShadowColor:kCalendarColorHeaderWeekdayShadow];
    [l setTextAlignment:NSTextAlignmentCenter];
    [l setFont:[UIFont fontWithName:Trebuchet_MS size:10]];
...
// [UIColor colorWithRed:0.981 green:1.000 blue:0.985 alpha:1.000];
@end
