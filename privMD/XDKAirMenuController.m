...
- (void)viewDidLoad
{
    ...
    _images_off = [[NSArray alloc]initWithObjects:@"menu_home",@"menu_booking",@"menu_payment",@"menu_user",@"menu_user",@"menu_info",@"menu_logout", nil];
    
    _images_on = [[NSArray alloc]initWithObjects:@"menu_home_on",@"menu_booking_on",@"menu_payment_on",@"menu_user_on",@"menu_user_on",@"menu_info_on",@"menu_logout_on", nil];
    

    
    _menuTitle = [[NSArray alloc]initWithObjects:@"HOME",@"HISTORY",@"PAYMENT",@"PROFILE",@"RESET PASSWORD",@"ABOUT",@"LOGOUT",nil];
...
//        
//        
//        NSString *postText =  [NSString stringWithFormat:@"Spread the Sigma Driver https://itunes.apple.com/us/app/Sigma-driver/id1067269542?ls=1&mt=8 \n Sigma Passenger :https://itunes.apple.com/us/app/Sigma/id1064407732?ls=1&mt=8"];
...
//        [activityController setValue:@"Sigma App" forKey:@"subject"];
//        
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
     ...
     cell.menutitle.highlightedTextColor = UIColorFromRGB(0x333333);
...
//        
//        NSLog(@">>>>1>>>> Swith ON");
//        appDelegate._IsSwitchOn=YES;
//        
//    }else{
//        
//        
//        NSLog(@">>>>0>>> Swith OFF");
//         appDelegate._IsSwitchOn=NO;
//    }
//    
