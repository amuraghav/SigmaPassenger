...
-(void)unSubscribeOnChannels:(NSArray *)pnChannelNames{
    NSArray *channels = [PNChannel channelsWithNames:pnChannelNames];
    [PubNub unsubscribeFromChannels:channels];
}
...
{
    TELogInfo( @"%@", [NSString stringWithFormat:@"failed: %@ error: %@", message.message ,[error localizedDescription]] );
}

- (void)pubnubClient:(PubNub *)client didSendMessage:(PNMessage *)message
{
    TELogInfo( @"%@", [NSString stringWithFormat:@"send: %@", message.message] );
}
