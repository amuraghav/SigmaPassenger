...
- (void)viewDidLoad
{
    ...
    typeO = [[NSArray alloc]initWithObjects:@"REQUEST",@"RIDE",@"RATE",nil];
    typeoDetails = [[NSArray alloc]initWithObjects:@"Tap to select pickup location",@"Sit back and relax your driver will take you where you want to go",@"Help us to maintain a quality service by rating your experience",nil];
...
-(void)createScrollingView
{
    NSArray *colors = [[NSArray alloc]initWithObjects:
                       [UIImage imageNamed:@"support_requestpickup"],
                       [UIImage imageNamed:@"support_ride"],
                       [UIImage imageNamed:@"support_rate"],
                       nil];
...
-(void)createBottomView:(NSUInteger )widtH
{
    ...
    typeLabel.tag = 100;
    [Helper setToLabel:typeLabel Text:[typeO objectAtIndex:widtH] WithFont:Trebuchet_MS_Bold FSize:15 Color:UIColorFromRGB(0x333333)];
    ...
    [Helper setToLabel:typeDetailsLabel Text:[typeoDetails objectAtIndex:widtH] WithFont:Trebuchet_MS FSize:15 Color:UIColorFromRGB(0x666666)];
...
-(void)createBottomView1
{
    ...
    [BottomLabel setFrame:CGRectMake(10,yOffset - 50,300,40)];

    BottomLabel.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    [Helper setButton:BottomLabel Text:@"Have an issue visit us?" WithFont:Trebuchet_MS FSize:15 TitleColor:UIColorFromRGB(0xffffff) ShadowColor:nil];
