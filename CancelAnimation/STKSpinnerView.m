...
@property (nonatomic, assign) CATextLayer *textlabel;
...
- (void)_commonInit
{
    ...
    [label setFont:Trebuchet_MS];
    [label setFontSize:10];
    [label setWrapped:YES];
    //[label setString:@"8\nmin"];
    label.doubleSided = NO;
    label.zPosition = 256;
...
- (void)setTextlabel:(CATextLayer *)textlabel
{
    _textlabel = textlabel;
}
-(void)setText:(NSString *)string {
    
    [_textlabel setString:string];
}
- (UIImage *)image
{
...
- (void)setProgress:(float)progress animated:(BOOL)animated
{
  ...
  //  [[self wellLayer] setStrokeEnd:1-_progress];
...
- (void)layoutSubviews
{
    ...
    [[self textlabel] setFrame:bounds];
